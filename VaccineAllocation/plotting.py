...
colors = {'S': 'b', 'S0': 'b', 'E': 'y', 'IA': 'c', 'IY': 'm', 'IH': 'k', 'R': 'g', 'D': 'k', 'ToIHT': 'teal', 'ToIHT_moving': 'teal', 'ToIA': 'teal', 'ToIY_moving': 'teal','ToIHT_unvac': 'teal', 'ToIHT_vac': 'teal', 'ICU': 'k', 'ICU_ratio': 'k','ToICU': 'teal', 'IHT': 'k', 'ITot': 'k'}
light_colors = {'IH':'silver','ToIHT':'paleturquoise', 'ToIHT_moving':'paleturquoise', 'D': 'teal', 'ToIHT_unvac':'paleturquoise', 'ToIHT_unvac':'paleturquoise','ToIA':'paleturquoise', 'ToIY_moving': 'paleturquoise', 'ICU':'silver', 'ICU_ratio':'silver','ToICU': 'paleturquoise', 'IHT': 'silver', 'ITot': 'silver', 'S': 'blue', 'S0': 'blue'}
l_styles = {'sim': '-', 'opt': '--'}
compartment_names = {
...
def plot_multi_tier_sims(instance_name,
    ...
    states_to_plot_temp = ['IHT', 'ToIHT', 'ICU', 'D', 'ToIA', 'S0']
    ...
    states_to_plot_temp = ['IHT', 'ToIHT', 'ICU', 'D', 'ToIA', 'ToIY','ToIHT_moving', 'ToIY', 'S0']
    ...
    # Stats
    all_states = ['S', 'E', 'IH', 'IA', 'IY', 'R', 'D', 'S0']
    if 'ICU' in profiles[0].keys():
    ...
    for v in plot_left_axis:
        ...
        if v == 'S0':                
            v_a = ax1.plot(all_st['S0'].T * bed_scale, c=colors[v], linestyle=l_style, linewidth=2, label=label_v, alpha=1 * hide, zorder = 50)
