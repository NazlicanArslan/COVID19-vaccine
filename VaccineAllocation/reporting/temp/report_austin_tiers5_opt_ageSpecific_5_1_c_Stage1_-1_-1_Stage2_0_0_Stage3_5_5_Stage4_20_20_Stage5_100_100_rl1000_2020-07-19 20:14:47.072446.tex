...
\multirow{3}{\hsize}{Cumulative deaths}       & Mean      & 1753 \\ \cmidrule(l){2-3} 
                                     & Median    & 1752                        \\ \cmidrule(l){2-3} 
                                     & 5\%-95\% PI & (1752 - 1752)           \\  \midrule
Risk Group                           & Age Group & \multicolumn{1}{c}{\% deaths}        \\  \midrule
\multirow{5}{*}{Low   risk}          & 0-4y      & 0.00                         \\ \cmidrule(l){2-3} 
                                     & 5-17y     & 0.11                         \\ \cmidrule(l){2-3} 
                                     & 18-49y    & 4.68                         \\ \cmidrule(l){2-3} 
                                     & 50-64y    & 8.27                         \\ \cmidrule(l){2-3} 
                                     & 65y+      & 4.91                         \\ \midrule
\multirow{5}{*}{High   risk}         & 0-4y      & 0.00                         \\ \cmidrule(l){2-3} 
                                     & 5-17y     & 0.11                         \\ \cmidrule(l){2-3} 
                                     & 18-49y    & 6.79                         \\ \cmidrule(l){2-3} 
...
\multirow{5}{\hsize}{Probability of exceeding \% of hospital capacity} & 60\% & 1.0   \\ \cmidrule(l){2-3} 
                                     ...
                                     & 100\%     & 0.0                                \\ \midrule
\multirow{3}{\hsize}{Peak COVID-19 daily hospitalizations \\ (heads in beds)} & Percentile 5 & 973  \\ \cmidrule(l){2-3} 
                                     & Percentile 50      & 973    \\ \cmidrule(l){2-3} 
                                     & Percentile 95     & 973     \\ \midrule
