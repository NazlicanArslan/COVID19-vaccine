...
if __name__ == '__main__':
    ...
    from vaccine_policy_search_functions import deterministic_vaccine_search
    ...
    given_allocation = True if args.v_allocation is not None else False
    ...
    if given_allocation is not False:
            selected_vaccine_policy = VAP.vaccine_policy(instance, vaccines, vaccines.fixed_vaccine_allocation)
    ...
    best_policy_replicas, best_policy, out_file = deterministic_vaccine_search(instance=instance,
                                                                               tiers=tiers.tier,
                                                                               vaccines=vaccines,
